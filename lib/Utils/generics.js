...
const generateMessageIDV2 = userId => {
  ...
  return 'OTA' + hash.toString('hex').toUpperCase().substring(0, 18);
};
// generate a random ID to attach to a message
exports.generateMessageIDV2 = generateMessageIDV2;
const generateMessageID = () => 'OTA' + (0, _crypto.randomBytes)(18).toString('hex').toUpperCase();
exports.generateMessageID = generateMessageID;
const generateIOSMessageID = () => {
  const prefix = '3A';
  const random = (0, _crypto.randomBytes)(10);
...
const generateAndroMessageID = () => {
  return (0, _crypto.randomBytes)(16).toString('hex').toUpperCase().substring(0, 21);
};
